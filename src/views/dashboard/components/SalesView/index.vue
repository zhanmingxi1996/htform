    ...
    <el-card shadow="hover" :body-style="{ padding: '0 0 20px 0' }">
      ...
      <template>
        <div class="sales-view-chart-wrapper">
          <v-chart :options="chartOption" :autoresize="true"/>
  ...
  export default {
    data() {
      return {
        ...
        chartOption: {},
        orderFullYear:[2543,2454,3354,1244,2435,4252,3123,3456,2312,1433,2352,2523],
        orderFullYearAxis:['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
        userFullYear:[2435,4252,3123,2543,2454,3354,3456,2312,1433,1244,2435,4252],
